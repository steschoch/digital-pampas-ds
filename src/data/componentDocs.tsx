...
const PORTAL_DOCS: PortalDocCfg[] = [
  ...
  },
  {
    ...
    prompt: '## TopBar\nProps: leading?, trailing?, onMenuClick?, menuButtonRef?, menuButtonLabel?, menuExpanded?. Height --dp-nav-height, sticky, shadow on scroll.',
    ...
    a11y: [{ rule: 'header landmark; labelled menu button', status: 'pass' }, { rule: 'menuExpanded exposes aria-expanded; menuButtonRef returns focus on close', status: 'pass' }],
    guidelines: [{ type: 'do', text: 'Pair the hamburger with the Sidebar drawer.' }, { type: 'do', text: 'Hold menuButtonRef and focus it when the drawer closes — otherwise the keyboard user is dropped back at the top of the document.' }, { type: 'dont', text: 'Overfill it — keep to context + a few actions.' }],
  },
  {
